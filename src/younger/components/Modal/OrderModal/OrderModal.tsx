import MenuItem from 'younger/components/MenuItem/MenuItem';
import ModalStyles from 'younger/components/Modal/Modal.module.css';
import { Button } from 'younger/components/atoms/Button';
import { EXTRA_PRICE } from 'constant';
import { ProductInfo, ProductOrder } from 'younger/pages/types';
