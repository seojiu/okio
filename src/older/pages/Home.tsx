...
import useProducts from 'older/hooks/useProducts';
import menuOrderReducer from 'menuOrderReducer';
import { useEffect, useReducer, useRef, useState } from 'react';
import { formatAllCategories, formatProducts } from 'older/utils';
...
export default function Home({ navigate }: HomeProps) {
  ...
  const categoryNavbarInfo = products.length ? products.map((category: CategoryInfo) => {
