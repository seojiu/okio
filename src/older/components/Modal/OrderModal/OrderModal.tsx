import MenuItem from 'older/components/MenuItem/MenuItem';
import ModalStyles from 'older/components/Modal/Modal.module.css';
import { Button } from 'older/components/atoms/Button';
import { EXTRA_PRICE } from 'constant';
import { ProductInfo, ProductOrder } from 'older/pages/types';
